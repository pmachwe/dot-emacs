...
#+BEGIN_SRC emacs-lisp
  ...
  ;; grep and find
  (global-set-key (kbd "C-c g g") 'helm-do-zgrep)
  (global-set-key (kbd "C-c g r") 'rgrep)
  (global-set-key (kbd "C-c f g") 'find-grep)

  ;; Kill-line from any point
  ;; Not required because C-w will do this
  ...
  ;; use M-o to switch buffer because C-. does not work on Putty
  (global-set-key (kbd "M-o") 'ido-switch-buffer)

  (global-set-key (kbd "C-,") 'ido-find-file)

  ;; M-v is scroll-down
  ;; Making M-c (which converts to camel-case)
  ;;   as scroll-up
  (global-set-key (kbd "M-c") 'scroll-up)

  ;; C-v is FREE now
  ;; M-k does some scrolling which is never used
  ...
  ;; reuse C-v for end of buffer
  ;; especially useful for shell
  (global-set-key (kbd "C-v") 'end-of-buffer)

  ;; C-/ is for <undo> which also has C-_
  ;; using this for helm-imenu
  (global-set-key (kbd "C-/") 'helm-imenu)

  ;; M-o to switch to other buffer
  ;(global-set-key (kbd "M-o") (lambda() (interactive) (other-window 1)))
  ;(global-set-key (kbd "M-S-o") (lambda() (interactive) (other-window 2)))
...
+ =find-file-other-window=: Bound to C-x 4 f.
