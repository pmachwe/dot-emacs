...
#+BEGIN_SRC emacs-lisp
  ...
  (defun my/setup-counsel-gtags()
    (interactive)
    (let (f)
      (setq f "/Users/pmachwe/.emacs.d/fromgit/emacs-counsel-gtags/counsel-gtags.el")
      (if (file-exists-p f)
          (progn
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; grep and find
  (define-key my-keys-minor-mode-map (kbd "C-c g g") 'counsel-grep)
  (define-key my-keys-minor-mode-map (kbd "C-c g r") 'rgrep)
  (define-key my-keys-minor-mode-map (kbd "C-c f g") 'find-grep)
  (define-key my-keys-minor-mode-map (kbd "C-c /") 'counsel-imenu)
