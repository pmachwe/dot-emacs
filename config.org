...
keybindings are unused. Using C-m for now.
...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key my-keys-minor-mode-map (kbd "C-m h S") '(lambda()
                                                        (interactive)
                                                       (find-file-other-window (concat emacs-help-dir "smartparens.txt"))))

  (define-key my-keys-minor-mode-map (kbd "C-m h M") '(lambda()
                                                        (interactive)
                                                        (find-file-other-window (concat emacs-help-dir "magit.org"))))

  (define-key my-keys-minor-mode-map (kbd "C-m h C") '(lambda()
                                                        (interactive)
